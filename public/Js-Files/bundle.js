...
exports.showUpdateAlert = exports.showAlert = exports.hideAlert = void 0;
...
var showUpdateAlert = function showUpdateAlert(type, msg, pop) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
...
exports.showUpdateAlert = showUpdateAlert;
},{}],"login-page.js":[function(require,module,exports) {
"use strict";
...
exports.updatePasswordData = exports.updateData = void 0;
...
var updateData = function updateData(firstName, lastName, username, email) {
  //try {
  (0, _axios.default)({
    method: "PATCH",
    ...
    if (result.data.status === "success") {
      (0, _alerts.showUpdateAlert)("success", "Data updated successfully!!");
    }
  }).catch(function (err) {
    if (err.response) {
      (0, _alerts.showUpdateAlert)("error", err.response.data.message);
    } else if (err.request) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"DataUpload.js":[function(require,module,exports) {
"use strict";
...
var createBudget = function createBudget(budget) {
  (0, _axios.default)({
    ...
    if (res.data.status === "Success") {
      (0, _alerts.showAlert)("success", "Budget created successfully!!");
    }
  }).catch(function (err) {
    if (err.response) {
      (0, _alerts.showAlert)("error", "You have an existing budget,Delete it to create a new one ");
    } else if (err.request) {
      console.log(err.request);
    } else {
      console.log(err.message);
...
var createExpense = function createExpense(data) {
  ...
  (0, _axios.default)({
    ...
    //console.log(res);
    if (res.data.status === "Success") {
      (0, _alerts.showUpdateAlert)("success", "Expense Created successfully!!");
...
var updateExpense = function updateExpense(data) {
  ...
  (0, _axios.default)({
    ...
    if (res.data.status === "success") {
      (0, _alerts.showUpdateAlert)("success", "Expense updated successfully!!", "pop");
      setTimeout(window.location.reload(true), 500);
    }
  }).catch(function (err) {
    if (err.response) {
      (0, _alerts.showUpdateAlert)("error", err.response.data.message, "pop");
    } else if (err.request) {
      console.log(err.request);
    } else {
      console.log(err.message);
...
var _DataUpload = require("./DataUpload");
...
var toggleBar1 = document.querySelector(".toggle-bar-1");
var toggleBar2 = document.querySelector(".toggle-bar-2");
var toggleBar3 = document.querySelector(".toggle-bar-3");
var mainNav = document.querySelector(".main-nav"); //Create Budget buttons

var create_Budget_Btn = document.querySelector(".Create-Budget");
var view_Budget_Btn = document.querySelector(".View-Budget");
var cancel_Btn = document.querySelector("#cancel");
var save_Btn = document.querySelector("#save");
var delete_Budget_CTA = document.querySelector(".delete-budget");
var delete_Budget_Btn = document.querySelector("#delete-budget");
var backdrop = document.querySelector(".backdrop");
var new_Budget_form = document.querySelector(".new-budget-container");
var cancel_toggle_bar = document.querySelector(".cancel-btn"); //Expense icons

var editExpenseIcons = document.querySelectorAll(".edit-expense");
var deleteEXpenseIcons = document.querySelectorAll(".delete-expense");
var editExpenseContainer = document.querySelector(".edit-budget-container");
var deleteExpenseContainer = document.querySelector(".delete-expense-container");
var deleteBudgetContainer = document.querySelector(".delete-budget-container");
var cancelExpenseBtns = document.querySelectorAll(".expense-Cancel");
var expenseTitle = document.querySelector("#expense-title");
var allocatedExpense = document.querySelector("#expense-Allocated");
var expenseSpent = document.querySelector("#expense-Spent");
var percentValue = document.querySelector(".percent-value");
var progressBars = document.querySelectorAll("#myBar");
var update_Expense_Btn = document.querySelector("#expense-Save");
...
var save_new_expenditure = document.querySelector(".add-new-expenditure");
var ctx = document.getElementById("pieChart");
var allocation_Of_All_Expenses = document.querySelectorAll(".item-budget i"); //const title_Of_All_Expenses = document.querySelectorAll(".item-name");
//Declare all the variables

var allocated_expenses_Array = [];
var expense_title_Array = [];
var bgcolorArray = [];
var borderColorArray = [];
var expenseID, budgetId; //Generate a random color

var generateMycolor = function generateMycolor(opacity) {
  var randomColor = "rgba(".concat(Math.floor(Math.random() * 255), ",").concat(Math.floor(Math.random() * 255), ",").concat(Math.floor(Math.random() * 240), ",").concat(opacity, ")");
  return randomColor;
}; //Collection of data to be used in the chart


if (allocation_Of_All_Expenses) {
  allocation_Of_All_Expenses.forEach(function (el) {
    var currentExpenseTitle = el.parentElement.parentElement.previousSibling.firstChild.firstChild.textContent;
...
if (delete_Budget_CTA) {
  delete_Budget_CTA.addEventListener("click", function () {
...
if (add_new_expenditure_btn) {
  add_new_expenditure_btn.addEventListener("click", function () {
...
if (editExpenseIcons) {
  editExpenseIcons.forEach(function (el) {
    return el.addEventListener("click", function () {
      ...
      allocatedExpense.value = el.parentElement.parentElement.nextSibling.firstChild.lastChild.textContent;
      expenseSpent.value = el.parentElement.parentElement.nextSibling.lastChild.lastChild.textContent;
    });
  });
}

if (deleteEXpenseIcons) {
  deleteEXpenseIcons.forEach(function (el) {
...
if (cancelExpenseBtns) {
  cancelExpenseBtns.forEach(function (el) {
    el.addEventListener("click", function () {
...
if (create_Budget_Btn) {
  create_Budget_Btn.addEventListener("click", function () {
    new_Budget_form.style.display = "block";
    backdrop.style.display = "block";
  });
  cancel_toggle_bar.addEventListener("click", function () {
...
if (document.querySelector(".form")) {
  var submitBtn = document.forms[0][2];
  var rememberMeBtn = document.forms[0][3];
  var forgotPassword = document.forms[0][4];
  var loginMessage = document.querySelector(".login-message");
  submitBtn.addEventListener("click", function () {
    event.preventDefault();
    var enteredUsername = document.forms[0][0];
    var enteredpassword = document.forms[0][1]; //this controls what happens when the sign up button is clicked

    (0, _loginPage.login)(enteredUsername.value, enteredpassword.value);
...
if (document.querySelector(".user-password")) {
  ...
  document.querySelector("#update").addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
...
mainNav.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
  var i;
